...
export default class KitchenSync extends React.Component {
  render() {
    return (
      ...
      <div className="workspace-tabs"
        style={
          ...
          <div className="workspace-tab-container-inner">
            ...
            <div className="workspace-tab-header" aria-label="Sekund">
              <div className="workspace-tab-header-inner">
                <div className="workspace-tab-header-inner-icon">
                  <svg viewBox="0 0 100 100" className="sekund"
                    width={17}
                    height={17}>
                    <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 600 600" xmlSpace="preserve">
                      <style type="text/css"
                        dangerouslySetInnerHTML={
                          { __html: "\n .st0{fill:#F4526A;}\n .st1{fill:#FFFFFF;}\n" }
                        } />
                      <circle className="st0"
                        cx={300}
                        cy={300}
                        r={300} />
                      <path className="st1" d="M181.39,201.53c-54.76,0-99.15,43.39-99.15,99.15c0,69.19,57.87,100.21,90.89,100.21
                         c-7.22,38.27-24.8,71.34-71.25,112.67c121.9-33.07,182.83-121.9,182.83-206.62C284.7,239.76,236.15,201.53,181.39,201.53z"/>
                      <path className="st1" d="M416.28,201.53c-54.76,0-99.15,43.39-99.15,99.15c0,69.19,57.87,100.21,90.89,100.21
                ...
                <div className="workspace-tab-header-inner-icon">
                  <svg viewBox="0 0 100 100" className="hackernews"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 24" fill="none"
                      ...
                      className="feather feather-book-open"><path d="M21.27,0c-1.174,2.021-5.5,9.464-5.532,9.499h-0.11C15.595,9.464,11.424,2.073,10.253,0H3.148l9.253,15.034v15.927h6.157 V15.034L27.812,0H21.27z" /></svg>
                  </svg>
                </div>
              </div>
            </div>
          </div>
          <div className="workspace-tab-container-after is-after-active"><div className="workspace-tab-header-inner" /></div>
        </div>
        <div className="workspace-leaf"><hr className="workspace-leaf-resize-handle" /><div className="workspace-leaf-content" data-type="hackernews-view">
          <div className="view-header">
            <div className="view-header-icon" aria-label="Faire glisser pour réorganiser">
              <svg viewBox="0 0 100 100" className="hackernews"
                width={18}
                height={18}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 24" fill="none"
